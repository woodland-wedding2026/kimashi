    ...
    egui::Hyperlink::from_label_and_url(
        ...
        "https://maps.app.goo.gl/WtrCENyrHQ23ziUL9",
            ...
            egui::Window::new(self.button3.clone()).open(&mut self.flag3).show(ctx, |ui| {
                ...
                ui.horizontal(|ui| {
                ui.label(egui::RichText::new("Paypal: ").size(17.0).color(egui::Color32::from_rgb(0, 0, 0)).strong()); ui.label(egui::RichText::new("woodland.wedding@pm.me   Subject: Woodland Wedding\n").size(17.0));
                });
                ...
                ui.horizontal(|ui| {
                ui.label(egui::RichText::new("Paypal: ").size(17.0).color(egui::Color32::from_rgb(0, 0, 0)).strong()); ui.label(egui::RichText::new("woodland.wedding@pm.me   Betreff: Woodland Wedding\n").size(17.0));
                });
                
                ui.horizontal(|ui| {
                ui.label(egui::RichText::new("Konto: ").size(17.0).color(egui::Color32::from_rgb(0, 0, 0)).strong()); ui.label(egui::RichText::new("Kimberley Hofer & Matthias Hofer, DE...  Betreff: Woodland Wedding").size(17.0));
                });
